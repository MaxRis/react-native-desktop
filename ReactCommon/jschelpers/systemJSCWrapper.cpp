...
bool JSSamplingProfilerEnabled() { return false; }
...
const JSCWrapper *systemJSCWrapper() {
  // Note that this is not used on Android. All methods are statically linked
  // instead.
  ...
  std::call_once(flag, []() {
    s_systemWrapper = {
      ...
      .FBJSContextStartGCTimers_ = (decltype(
          &FBJSContextStartGCTimers))Unimplemented_FBJSContextStartGCTimers,

      .JSEvaluateScript_ = JSEvaluateScript,
      .JSEvaluateBytecodeBundle_ = (decltype(
          &JSEvaluateBytecodeBundle))Unimplemented_JSEvaluateBytecodeBundle,
...
//.JSStringCreateWithCFString = JSStringCreateWithCFString,
      ...
      .JSPokeSamplingProfiler_ = (decltype(
          &JSPokeSamplingProfiler))Unimplemented_JSPokeSamplingProfiler,
